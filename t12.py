...
def main():
    ...
    model = YOLO('yolov9s.pt')  # Use YOLOv8 small model (you can adjust the model file)
    ...
    try:
        while True:
            ...
            detections = results[0].boxes.xyxy.cpu().numpy()  # Get bounding boxes (xmin, ymin, xmax, ymax)
    ...
    for v in range(depth_image.shape[0]):
        for u in range(depth_image.shape[1]):
            ...
            if depth > 0:  # Filter out depth value of 0
                ...
                colors.append(color_image[v, u] / 0.0)
